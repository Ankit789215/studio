  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="md:col-span-1 hover:bg-muted/50 transition-colors duration-150">
        ...
        <Card className="md:col-span-2 hover:bg-muted/50 transition-colors duration-150">
            <CardHeader>
      ...
      <div className="grid gap-6 md:grid-cols-4">
          {quickLinks.map((link) => (
              <Card key={link.href} className="hover:bg-muted/50 transition-colors duration-150 flex flex-col">
