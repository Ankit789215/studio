  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="md:col-span-1 hover:shadow-lg hover:scale-105 transition-all duration-200">
        ...
        <Card className="md:col-span-2 hover:shadow-lg hover:scale-105 transition-all duration-200">
            <CardHeader>
      ...
      <div className="grid gap-6 md:grid-cols-4">
          {quickLinks.map((link) => (
              <Card key={link.href} className="hover:shadow-lg hover:scale-105 transition-all duration-200 flex flex-col">
